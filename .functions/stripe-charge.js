...
const stripe = __webpack_require__(12)('sk_test_51MjICwDMiDAm4KQ1be5hfaDlN4BVYINt0kNvXW8pwz8yu1sDkRzhEeVpFJWvetqInw7MLP5rEmcaUaQ1VOKUPQ8E00Z1ZzReo1');
...
const StripeMethod_1 = __webpack_require__(38);
...
Object.defineProperty(exports, "__esModule", { value: true });
const NodePlatformFunctions_1 = __webpack_require__(13);
const stripe_common_1 = __webpack_require__(36);
...
const NodeCryptoProvider_1 = __webpack_require__(15);
const NodeHttpClient_1 = __webpack_require__(16);
const PlatformFunctions_1 = __webpack_require__(19);
...
class NodePlatformFunctions extends PlatformFunctions_1.PlatformFunctions {
    constructor() {
        super();
        this._exec = __webpack_require__(35).exec;
...
const crypto = __webpack_require__(9);
const CryptoProvider_1 = __webpack_require__(5);
/**
...
const FetchHttpClient_1 = __webpack_require__(20);
const SubtleCryptoProvider_1 = __webpack_require__(21);
/**
...
var getSideChannel = __webpack_require__(24);
...
var utilInspect = __webpack_require__(32);
...
module.exports = __webpack_require__(33).inspect;
...
const _Error = __webpack_require__(4);
const HttpClient_1 = __webpack_require__(3);
const utils_1 = __webpack_require__(2);
const CryptoProvider_1 = __webpack_require__(5);
const RequestSender_1 = __webpack_require__(37);
const StripeResource_1 = __webpack_require__(1);
const Webhooks_1 = __webpack_require__(40);
const resources = __webpack_require__(41);
...
const defaultRequestSenderFactory = (stripe) => new RequestSender_1.RequestSender(stripe, StripeResource_1.StripeResource.MAX_BUFFERED_REQUEST_METRICS);
function createStripe(platformFunctions, requestSender = defaultRequestSenderFactory) {
    Stripe.PACKAGE_VERSION = __webpack_require__(131).version;
    ...
    Stripe.prototype = {
        ...
        _setApiNumberField(prop, n, defaultVal) {
            const val = (0, utils_1.validateInteger)(prop, n, defaultVal);
...
const utils_1 = __webpack_require__(2);
const autoPagination_1 = __webpack_require__(39);
/**
...
const { resourceNamespace } = __webpack_require__(42);
module.exports = {
    // Support Accounts for consistency, Account for backwards compatibility
    Account: __webpack_require__(11),
    AccountLinks: __webpack_require__(43),
    Accounts: __webpack_require__(11),
    ApplePayDomains: __webpack_require__(44),
    ApplicationFees: __webpack_require__(45),
    Balance: __webpack_require__(46),
    BalanceTransactions: __webpack_require__(47),
    Charges: __webpack_require__(48),
    CountrySpecs: __webpack_require__(49),
    Coupons: __webpack_require__(50),
    CreditNotes: __webpack_require__(51),
    Customers: __webpack_require__(52),
    Disputes: __webpack_require__(53),
    EphemeralKeys: __webpack_require__(54),
    Events: __webpack_require__(55),
    ExchangeRates: __webpack_require__(56),
    FileLinks: __webpack_require__(57),
    Files: __webpack_require__(58),
    InvoiceItems: __webpack_require__(60),
    Invoices: __webpack_require__(61),
    Mandates: __webpack_require__(62),
    OAuth: __webpack_require__(63),
    PaymentIntents: __webpack_require__(64),
    PaymentLinks: __webpack_require__(65),
    ...
    Quotes: __webpack_require__(72),
    Refunds: __webpack_require__(73),
    Reviews: __webpack_require__(74),
    SetupAttempts: __webpack_require__(75),
    SetupIntents: __webpack_require__(76),
    ShippingRates: __webpack_require__(77),
    Sources: __webpack_require__(78),
    SubscriptionItems: __webpack_require__(79),
    Subscriptions: __webpack_require__(80),
    SubscriptionSchedules: __webpack_require__(81),
    TaxCodes: __webpack_require__(82),
    TaxRates: __webpack_require__(83),
    Tokens: __webpack_require__(84),
    Topups: __webpack_require__(85),
    Transfers: __webpack_require__(86),
    WebhookEndpoints: __webpack_require__(87),
    Apps: resourceNamespace('apps', {
        Secrets: __webpack_require__(88),
    }),
    BillingPortal: resourceNamespace('billingPortal', {
        Configurations: __webpack_require__(89),
        Sessions: __webpack_require__(90),
    }),
    Checkout: resourceNamespace('checkout', {
        Sessions: __webpack_require__(91),
    }),
    FinancialConnections: resourceNamespace('financialConnections', {
        Accounts: __webpack_require__(92),
        Sessions: __webpack_require__(93),
    }),
    Identity: resourceNamespace('identity', {
        VerificationReports: __webpack_require__(94),
        VerificationSessions: __webpack_require__(95),
    }),
    Issuing: resourceNamespace('issuing', {
        Authorizations: __webpack_require__(96),
        Cardholders: __webpack_require__(97),
        Cards: __webpack_require__(98),
        Disputes: __webpack_require__(99),
        Transactions: __webpack_require__(100),
    }),
    Radar: resourceNamespace('radar', {
        EarlyFraudWarnings: __webpack_require__(101),
        ValueListItems: __webpack_require__(102),
        ValueLists: __webpack_require__(103),
    }),
    Reporting: resourceNamespace('reporting', {
        ReportRuns: __webpack_require__(104),
        ReportTypes: __webpack_require__(105),
    }),
    Sigma: resourceNamespace('sigma', {
        ScheduledQueryRuns: __webpack_require__(106),
    }),
    Terminal: resourceNamespace('terminal', {
        Configurations: __webpack_require__(107),
        ConnectionTokens: __webpack_require__(108),
        Locations: __webpack_require__(109),
        Readers: __webpack_require__(110),
    }),
    TestHelpers: resourceNamespace('testHelpers', {
        Customers: __webpack_require__(111),
        Refunds: __webpack_require__(112),
        TestClocks: __webpack_require__(113),
        Issuing: resourceNamespace('issuing', {
            Cards: __webpack_require__(114),
        }),
        Terminal: resourceNamespace('terminal', {
            Readers: __webpack_require__(115),
        }),
    ...
    Treasury: resourceNamespace('treasury', {
        CreditReversals: __webpack_require__(121),
        DebitReversals: __webpack_require__(122),
        FinancialAccounts: __webpack_require__(123),
        InboundTransfers: __webpack_require__(124),
        OutboundPayments: __webpack_require__(125),
        OutboundTransfers: __webpack_require__(126),
        ReceivedCredits: __webpack_require__(127),
        ReceivedDebits: __webpack_require__(128),
        TransactionEntries: __webpack_require__(129),
        Transactions: __webpack_require__(130),
    }),
};
...
const { multipartRequestDataProcessor } = __webpack_require__(59);
const { StripeResource } = __webpack_require__(1);
const stripeMethod = StripeResource.method;
module.exports = StripeResource.extend({
    create: stripeMethod({
...
const { StripeResource } = __webpack_require__(1);
const stripeMethod = StripeResource.method;
const { stringifyRequestData } = __webpack_require__(2);
...
module.exports = {"name":"stripe","version":"11.13.0","description":"Stripe API wrapper","keywords":["stripe","payment processing","credit cards","api"],"homepage":"https://github.com/stripe/stripe-node","author":"Stripe <support@stripe.com> (https://stripe.com/)","contributors":["Ask Bjørn Hansen <ask@develooper.com> (http://www.askask.com/)","Michelle Bu <michelle@stripe.com>","Alex Sexton <alex@stripe.com>","James Padolsey"],"repository":{"type":"git","url":"git://github.com/stripe/stripe-node.git"},"bugs":"https://github.com/stripe/stripe-node/issues","engines":{"node":">=12.*"},"main":"lib/stripe.node.js","types":"types/index.d.ts","devDependencies":{"@types/chai":"^4.3.4","@types/chai-as-promised":"^7.1.5","@types/mocha":"^10.0.1","@types/qs":"^6.9.7","@typescript-eslint/eslint-plugin":"^4.33.0","@typescript-eslint/parser":"^4.33.0","chai":"^4.3.6","chai-as-promised":"~7.1.1","coveralls":"^3.1.1","eslint":"^7.32.0","eslint-config-prettier":"^8.5.0","eslint-plugin-chai-friendly":"^0.7.2","eslint-plugin-prettier":"^3.4.1","mocha":"^8.4.0","mocha-junit-reporter":"^2.1.0","nock":"^13.2.9","node-fetch":"^2.6.7","nyc":"^15.1.0","prettier":"^1.16.4","ts-node":"^10.9.1","typescript":"^4.9.4"},"resolutions":{"minimist":"1.2.6","nanoid":"^3.2.0"},"dependencies":{"@types/node":">=8.1.0","qs":"^6.11.0"},"license":"MIT","scripts":{"build":"tsc -p tsconfig.json","clean":"rm -rf ./.nyc_output ./node_modules/.cache ./coverage ./lib","prepack":"yarn install && yarn build","mocha":"nyc mocha","mocha-only":"mocha","test":"yarn build && yarn test-typescript && yarn mocha","test-typescript":"tsc --build types/test","lint":"eslint --ext .js,.jsx,.ts .","fix":"yarn lint --fix && ./scripts/updateAPIVersion.js","report":"nyc -r text -r lcov report","coveralls":"cat coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js"},"exports":{"types":"./types/index.d.ts","browser":"./lib/stripe.worker.js","worker":"./lib/stripe.worker.js","default":"./lib/stripe.node.js"}}
